...
//Ðßíáêáò ìå ôçí ôéìÞ áëÞèåéáò êÜèå Literal          **ÈÝóåéò <[0-9] ÈåôéêÜ > < [10-19] ÁñíçôéêÜ > 
int literal[var*2];

//Ðßíáêáò ôïõ ðñïâëÞìáôïò.ÊÜèå êåëß áíôéðñïóùðåýåé Ýíá literal* êáé êÜèå ãñáììÞ áíôéðñïóùðåýåé åíáí üñï. 
// *Ç ôéìÞ ôïõ êÜèå êåëéïý åßíáé ï äåßêôçò ôçò èÝóçò ôïõ literal óôïí ðßíáêá literal[]
int problem [cl][3];

//Ðßíáêáò ðïõ áðïèçêåýåé ôç èÝóç ôùí false üñùí
int false_clauses[cl];

//ÅðéëïãÞ ôõ÷áßïõ false Clause 
int f_cl;
